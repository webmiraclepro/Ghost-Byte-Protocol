...
const Block = ({heading, description, img, }) => {
    return (
          <div className="mx-10 lg:mx-0 bg-bgblock shadow-block border-2 border-borderblock rounded-large flex flex-col justify-center items-center h-5/6 md: w-4/5 lg:w-full lg:h-full ">
